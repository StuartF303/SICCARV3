...
namespace WalletService.SQLRepository.Migrations
{
    ...
    partial class WalletContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Siccar.Platform.Registers.TransactionMetaData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Siccar.Platform.Registers.WalletAddress", b =>
                {
            ...
            modelBuilder.Entity("WalletService.Core.Models.WalletTransaction", b =>
                {
                    b.HasOne("Siccar.Platform.Registers.TransactionMetaData", "MetaData")
                        .WithMany()
