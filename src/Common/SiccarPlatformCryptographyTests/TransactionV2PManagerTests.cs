...
// PayloadManager V2 Class Unit Test File - The Welder/Skid Row
// 10.04.2021
...
{
	public class TransactionV2PManagerTests
	{
...
/* ImportPayloads() Tests */
		...
		public void ImportPayloadsOnePayloadUnencryptedNoRecipientsEmptyTx()
		{
			...
			Assert.NotNull(info);
			Assert.False(info.GetPayloadEncrypted());
			ITxFormat tx2 = TransactionBuilder.Build(TransactionVersion.TX_VERSION_2);
		...
		public void ImportPayloadsMultiPayloadMultiDiffWalletsUnencryptedEmptyTx()
		{
			...
			Assert.NotNull(info);
			Assert.False(info.GetPayloadEncrypted());
			tx = TransactionBuilder.Build(TransactionVersion.TX_VERSION_2);
