...
This constitution establishes the foundational principles, standards, and guidelines for the SICCARV3 project. All development, architectural decisions, and implementations must align with these principles.

## Project Overview

SICCARV3 is a distributed ledger platform built on microservices architecture, providing secure, scalable blockchain capabilities through a suite of specialized services including Wallet, Tenant, Register, Peer, Blueprint, Action, and Validator services.
...
- Use Dapr for microservices orchestration and service-to-service communication
...
- Target .NET 9 or later for all projects
...
**Document Control**
- **Created:** 2025-11-11
- **Authority:** SICCARV3 Architecture Team
