# SICCARV3 Specification Kit

This directory contains the specification-driven development artifacts for the SICCARV3 project using the [Spec-Kit](https://github.com/github/spec-kit) methodology from GitHub.
...
- [SICCARV3 Project README](../README.md)
- [SICCARV3 Contribution Guide](../pull_request_template.md)
