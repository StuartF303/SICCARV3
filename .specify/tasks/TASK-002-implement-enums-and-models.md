...
Define the foundational enums and data models that will be used throughout the Siccar.Cryptography library. These types form the contract between components and must be well-designed for extensibility and clarity.

**Related Specifications:**
- [Siccar.Cryptography Rewrite Spec](../specs/siccar-cryptography-rewrite.md#functional-requirements)
...
```csharp
namespace Siccar.Cryptography.Enums;
...
Create `Siccar.Cryptography.Tests/Unit/EnumsAndModelsTests.cs`:
